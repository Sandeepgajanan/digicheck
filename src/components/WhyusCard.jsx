...
const WhyUsCard = ({ title, desc, image }) => {
  return (
    <div className="relative ">
      <div className="relative w-80 h-80  shadow-2xl border border-zinc-100 rounded-md overflow-hidden max-sm:w-full">
        <Image
          src={image}
          alt={title}
          fill
      ...
      <div className="absolute -bottom-8 left-8 bg-[#ffdecc] p-4 rounded-b-xl w-80 h-28 z-20 shadow-lg max-sm:left-0 max-sm:-bottom-24 max-sm:w-full">
